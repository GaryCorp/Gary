"""Run GaryCorp specialist work by hand, inside the backend container.
    ...
    docker compose exec backend python -m app.team_cli review "Give GaryCorp browser automation" --agents susan,dave,linda
...
async def main(argv: list[str]) -> int:
    ...
    assign.add_argument("agent", choices=["susan", "dave", "linda"])
    ...
    review.add_argument("--agents", default="susan,dave,linda")
